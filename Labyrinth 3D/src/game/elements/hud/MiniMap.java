...
public class MiniMap {
	...
	public void draw(Graphics2D g){
		...
		g.drawImage(hud_elements.getSubimage(64*9 -10 ,64-10,126+20,126+20),64*13-20,64*6-20 , null); 
...
//		System.out.println(colX + " "+ colY);
		...
		if(prevColX < colX || prevColX > colX){
			MiniMapRectangle mmp = 
					new MiniMapRectangle(colX*(3*size), colY*(3*size), Maze.numberGrid[colX][colY]);
			path.add(mmp);
			prevColX = colX;
		}
